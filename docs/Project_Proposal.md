...
**Chosen Platform: Ztachip**Arducam 
...
The project aims to design and implement a **American Sign Language (ASL) alphabet recognition system** using the **Ztachip FPGA accelerator**. The system must maintain low latency, high accuracy, and operate efficiently on limited hardware resources.
...
3. Demonstrate **≥5× reduction** in inference latency compared to CPU.
4. Integrate and test a photo taken of an ASL sign to see if it can detect it as the right letter.
...
| 6 | Integration & testing | Working analysis |
