...
This directory contains all presentation materials submitted for the project across different milestones.
...
These presentations document the **evolution of the project** from proposal through final deployment and demonstrate:
...
All slides are aligned with the written report and the repository implementation.
